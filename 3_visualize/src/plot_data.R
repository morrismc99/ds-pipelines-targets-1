#This function was written to visualize the trial dataset for learning Targets

#Input: Processed data from second step in targets framework
#Output: a plot of these data
...
# Create a plot
  plot_path <- here::here("3_visualize/out/","figure_1.png")
  png(file = plot_path, width = 8, height = 10, res = 200, units = 'in')
